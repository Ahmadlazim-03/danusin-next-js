...
export function MobileMenu({ currentUser, avatarUrl }: MobileMenuProps) {
  ...
  const pb = new PocketBase(
    process.env.NEXT_PUBLIC_POCKETBASE_URL || "https://pocketbase.evoptech.com"
  );
      ...
      >
        ...
        <div className="overflow-y-auto flex-1">
              ...
              <div className="flex items-center gap-2">
                {[
                  ...
                  },
                  {
                    icon: Heart,
                    label: "Favorite",
                    href: "/dashboard/favorite/products",
                  },
                ].map((action) => (
                  <Button
                    key={action.label}
          ...
          <div className="px-4 py-2">
            <h3 className="mb-2 text-xs font-semibold uppercase tracking-wider text-neutral-500 dark:text-zinc-500">
              Discover
            </h3>
                ...
                return (
                  <li key={item.label}>
                    <Link
                      ...
                      onClick={closeMenu}
                    >
                      <Icon className="mr-0 h-4 w-4 text-neutral-500 dark:text-zinc-400 group-hover:text-emerald-500" />{" "}
                      {/* group-hover tidak berlaku di sini, warna ikon bisa diatur langsung atau diwariskan */}
          ...
          <div className="px-2 py-2">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="categories" className="border-none">
                <AccordionTrigger
                  className="py-2.5 px-2 text-sm font-medium rounded-md
                                           text-neutral-700 dark:text-zinc-300 
                                           hover:bg-neutral-100 dark:hover:bg-zinc-800
